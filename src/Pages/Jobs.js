  ...
  return (
    <div className='jobs'>
      ...
      <div className='text-center mt-4'>
        <button className={company===false?"jobbtn active mr-2":"jobbtn mr-2"} onClick={()=>setCompany(false)}>Seek a Job</button>|<button onClick={()=>setCompany(true)} className={company===true?"jobbtn active ml-2":"jobbtn ml-2"}>Post a Job</button>
      </div>
      {!company?
